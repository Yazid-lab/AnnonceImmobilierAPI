...
{
    /// <inheritdoc />
    public partial class RemovedAnnonceIdFromUtilisateur : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Annonces",
                columns: new[] { "Id", "DatePublication", "Description", "NbPieces", "Prix", "Superficie", "Titre", "UtilisateurId", "Adresse_CodePostal", "Adresse_Latitude", "Adresse_Longitude", "Adresse_Pays", "Adresse_Rue", "Adresse_Ville" },
                values: new object[] { 1, new DateTime(2023, 3, 30, 15, 47, 56, 933, DateTimeKind.Local).AddTicks(1794), "desc1", 2, 111m, 1, "annonce 1", 1, "code", 11.0, 22.0, "tunisia", "rue", "tunis" });
